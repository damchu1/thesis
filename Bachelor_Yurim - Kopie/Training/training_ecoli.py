...
from tokenisation import format_dataset, N_AA_TOKENS, N_CODON_TOKENS
...
training_set, validation_set, test_set = train_validate_test_split(
    path_to_csv="/work/home/yj90zihi/Bachelor_Yurim/Transformer/csv_files/e_coli_aa_nt_seqs.csv",
    train_size=0.8,
    valid_size=0.1
)
...
training_callbacks = [
    ...
    # repeated from the very beginning, but can be continued from the last saved state
    keras.callbacks.ModelCheckpoint(
        filepath="Checkpoint_directory/best_weights.ckpt",
        monitor="masked_accuracy",
        verbose=1,
        save_best_only=True,
...
with open(f"E-coli-6-genomes-trained-weights.pkl", "wb") as f:
    pickle.dump(
